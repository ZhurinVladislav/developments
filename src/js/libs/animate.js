...
if (ScrollTrigger.isTouch !== 1) {
  ...
  gsap.fromTo(
    '.home-page__about .about__content',
    { y: 0 },
    {
      y: -40,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.home-page__about .img-wrapper__img-item',
    { y: 0 },
    {
      y: 20,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.home-page__main-gallery .gallery__number',
    { y: 0 },
    {
      y: 50,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.home-page__main-gallery .rooms__number',
    { y: 0 },
    {
      y: 50,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.home-page__special-offers .special-offers__number',
    { y: 0 },
    {
      y: 50,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.basic-information__location .location__content',
    { y: 0 },
    {
      y: -40,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.basic-information__location .img-wrapper__img-item',
    { y: 0 },
    {
      y: 20,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.basic-information__concept .concept__content',
    { y: 0 },
    {
      y: -40,
      scrollTrigger: {
  ...
  gsap.fromTo(
    '.basic-information__concept .img-wrapper__img-item',
    { y: 0 },
    {
      y: 20,
      scrollTrigger: {
